...
INSERT INTO `authors`(`author_id`, `name`, `nationality`) VALUES (1,'Sam Altman','USA'),
(2,'Freddy Vega','COL'),
...
INSERT INTO `books` (`book_id`, `author_id`, `title`, `year`, `language`, `cover_url`, `price`, `sellable`, `copies`, `description`) VALUES (1,1,'The Startup Playbook',2013,'en',NULL,10.00,1,5,'Advice from the experts'),
